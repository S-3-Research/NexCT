export default function EmotionalSection() {
  return (
    <div className="px-6">
      <div className="max-w-[1100px] mx-auto my-5 bg-[#f7f9fb] border-l-4 border-[#1a6b7a] rounded-r-lg px-6 py-[14px] flex items-center gap-3 text-[16px] sm:text-[14px] text-[#0d2a3f]">
